...
pub const ETH_CONNECTOR_ACCOUNT_ID_TESTNET: &str = "eth.sepolia.testnet";
pub const ETH_CUSTODIAN_ADDRESS_TESTNET: &str = "0x4C8afA2fD22dB1c6091A96c382e6546529475B5c";
